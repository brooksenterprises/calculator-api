...
def main_gui(stock="APPL"):
    ...
    if 'error' in result_holder:
        return {"error":f"Error: {result_holder['error']}"}
        ...
        return {
            "title":{"text":title,"text_color":title_color, "font":("Helvetica", 16,)},
            "avg_volume": {"state":'PASS' if avg_volume_bool else 'FAIL', "text_color":"#006600" if avg_volume_bool else "#800000"},
            "iv30_rv30": {"state":'PASS' if iv30_rv30_bool else 'FAIL',"text_color":"#006600" if iv30_rv30_bool else "#800000"},
            "ts_slope_0_45":{"state":'PASS' if ts_slope_bool else 'FAIL', "text_color":"#006600" if ts_slope_bool else "#800000"},
            "expected_move":{"state":expected_move, "text_color":"blue"}
        }
